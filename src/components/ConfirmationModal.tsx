...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ 
    ...
    return (
        ...
        >
            {/* Modal box */}
            <div 
                className="bg-vesta-card-light dark:bg-vesta-card-dark rounded-xl shadow-2xl p-6 sm:p-8 max-w-md w-full transform transition-all duration-200 scale-100 opacity-100 animate-fade-in-up"
            ...
            >
                ...
                <div className="flex items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 className="text-lg leading-6 font-bold text-gray-900 dark:text-neutral-100">
                            {title}
                        </h3>
                        <div className="mt-2">
